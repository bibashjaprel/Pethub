        ...
        <Section>
          <Container maxWidth="md">
            ...
            <Typography variant="body1" color="textSecondary">
              At PetHub, we are dedicated to helping animals find their forever homes. We work with shelters
              and adoption centers to provide a safe, friendly platform where you can find pets that need a
              loving family. We believe every pet deserves a chance to find a happy home.
            </Typography>
          </Container>
        </Section>
      </motion.div>
